...
V1_0_0 = DecisionTable(
    namespace=AIVSS_NS,
    name="Inherent Model Characteristics",
    key="MCHX",
    version="0.1.0",
    definition="A decision table for assessing the inherent characteristics "
    "of AI models in the context of Agentic AI Risk Score (AARS)",
    decision_points={dp.id: dp for dp in [ND, OR, LMH]},
    outcome=LMH.id,
    mapping=[
        {
            "x_org.owasp#aivss:ND:0.1.0": "N",
            "x_org.owasp#aivss:OR:0.1.0": "N",
            "basic:LMH:1.0.0": "L",
        },
        {
            "x_org.owasp#aivss:ND:0.1.0": "P",
            "x_org.owasp#aivss:OR:0.1.0": "N",
            "basic:LMH:1.0.0": "L",
        },
        {
            "x_org.owasp#aivss:ND:0.1.0": "N",
            "x_org.owasp#aivss:OR:0.1.0": "P",
            "basic:LMH:1.0.0": "L",
        },
        {
            "x_org.owasp#aivss:ND:0.1.0": "F",
            "x_org.owasp#aivss:OR:0.1.0": "N",
            "basic:LMH:1.0.0": "M",
        },
        {
