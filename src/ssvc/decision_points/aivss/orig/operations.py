...
CONTINUOUS_MONITORING = DecisionPointValue(
    ...
    key="C",
    definition="Continuous security monitoring with automated incident response, regular security audits, and a dedicated SOC.",
)

COMPREHENSIVE_MONITORING = DecisionPointValue(
    name="Comprehensive Monitoring",
    key="M",
    definition="Comprehensive security monitoring using a SIEM system, automated alerts, and a well-defined, regularly tested incident response plan.",
)

BASIC_MONITORING = DecisionPointValue(
    name="Basic Monitoring",
    key="B",
    definition="Basic security monitoring, limited incident response capabilities, no formal incident response plan.",
)

NONE = DecisionPointValue(
    name="None",
    key="N",
    definition="No security monitoring or incident response plan, system logs not collected or analyzed.",
)
...
OPERATIONS = AivssDecisionPoint(
    ...
    key="OP",
    version="0.1.0",
    definition="Degree to which security monitoring and incident response are implemented in operations.",
    values=(
